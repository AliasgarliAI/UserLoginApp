...
import com.company.appUser.AppUserService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        AppUser user = new AppUser(request.getFirstName(),request.getLastName(),
        ...
        emailSender.sendTo(request.getEmail(),buildEmail(fullName,link));
        return token;

    }
    @Transactional
    public String confirmToken(String token){
        ConfirmationToken confToken = confirmationTokenService.getToken(token).orElseThrow(()->new IllegalStateException("token not found"));
       ...
       // confirmationTokenService.setConfirmedAt(token);
        ...
        em.merge(confToken);
        userService.enableUser(confToken.getAppUser().getEmail());
        return "confirmed";
    }
